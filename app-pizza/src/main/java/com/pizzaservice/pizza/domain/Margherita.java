...
public class Margherita implements Pizza {
    ...
    public static class Builder {
        ...
        private Builder withCrust(){
            this.crust = new Ingredient(IngredientType.CRUST);
            return this;
        }

        private Builder withSauce(){
            this.sauce = new Ingredient(IngredientType.TOMATO_SAUCE, 2);
            return this;
        }

        private Builder withToppings(){
            toppings = Arrays.asList(new Ingredient(IngredientType.CHEESE, 2));
            return this;
        }
    }
}
