...
class UserServiceImplTest {
    ...
    void shouldAddUser(){
        ...
        when(mockRepository.getAll()).thenReturn(Arrays.asList(user));
    ...
    void shouldReturnUsers(){
        ...
        when(mockRepository.getAll()).thenReturn(Arrays.asList(user, anotherUser));
    ...
    void shouldFindUserByFirstName(){
        ...
        when(mockRepository.searchByFullName("Test", "")).thenReturn(Arrays.asList(matchingUser, anotherMatchingUser));
        ...
        //when
        List<User> results = service.searchByName("Test", "");
