...
class UserRepositoryImplTest {
    ...
    void shouldAddUser(){
        ...
        //then
        assertThat(repository.getAll(), hasItem(user));
    }
    ...
    void shouldReturnUsers(){
        ...
        //then
        assertThat(repository.getAll(), hasItems(user, anotherUser));
    }
    ...
    void shouldFindUserByFirstName(){
        ...
        //when
        List<User> results = repository.searchByFirstName("test");
    ...
    void shouldFindUserBySurname(){
        ...
        //when
        List<User> results = repository.searchBySurname("Test");
    ...
    void shouldFindUserByFullName(){
        ...
        //when
        List<User> results = repository.searchByFullName("test", "test");
